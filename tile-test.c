...
main (int argc, char **argv)
{
	...
	gaim_tile = application_tile_new ("gaim.desktop");
	...
	gtk_box_pack_start (GTK_BOX (vbox), tile_get_widget (TILE (gaim_tile)), FALSE, FALSE, 0);
	...
	g_object_unref (G_OBJECT (gaim_tile));
